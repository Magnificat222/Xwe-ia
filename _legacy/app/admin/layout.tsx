    ...
    <div className="min-h-screen bg-noir">
      <header className="border-b border-ivoire/10 px-6 py-4">
        <div className="mx-auto flex max-w-6xl items-center gap-6">
          <Link href={isAdmin ? "/admin" : "/admin/support"} className="font-display text-lg text-ivoire">
          ...
          <nav className="flex flex-wrap gap-4 text-sm text-ivoire-dim">
            ...
            {isAdmin && <Link href="/admin/settings" className="hover:text-ivoire">Réglages</Link>}
          </nav>
        </div>
      </header>
